...
switch $wordcount_application {
    ...
    transit {
	ad_returnredirect transit-import?[export_vars -url { project_id task_type_id target_language_id return_url wordcount_file upload_file import_method}]
    }
    freebudget {
	ad_returnredirect freebudget-import?[export_vars -url { project_id task_type_id target_language_id return_url wordcount_file upload_file import_method}]
    }
    webbudget {
	ad_returnredirect webbudget-import?[export_vars -url { project_id task_type_id target_language_id return_url wordcount_file upload_file import_method}]
    }
    default {
