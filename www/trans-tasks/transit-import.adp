...
<%= [export_form_vars return_url project_id target_language_id import_method] %>
...
<tr>
	...
	This batch file included all default files (check in the list above). There is NO WAY to include/exclude 
	files in this batch.
